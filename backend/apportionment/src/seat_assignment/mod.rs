...
use super::{
    fraction::Fraction,
    structs::{ApportionmentError, ListNumber, ListVotes, SeatAssignmentInput},
};
...
fn list_numbers(standing: &[&ListStanding]) -> Vec<u32> {
...
mod tests {
    ...
    fn get_total_seats_per_converted_list_number_from_result(
        result: &SeatAssignmentResult,
    ) -> Vec<(u32, u32)> {
        result
            .final_standing
    ...
    mod lt_19_seats {
        ...
        use super::get_total_seats_per_converted_list_number_from_result;
        use crate::{
        ...
        fn test_without_remainder_seats() {
            ...
            let total_seats = get_total_seats_per_converted_list_number_from_result(&result);
            assert_eq!(
                total_seats,
                vec![(1, 6), (2, 2), (3, 2), (4, 2), (5, 1), (6, 1), (7, 1)]
            );
        }
        ...
        fn test_with_absolute_majority_of_votes_but_not_seats() {
            ...
            let total_seats = get_total_seats_per_converted_list_number_from_result(&result);
            assert_eq!(total_seats, vec![(1, 8), (2, 3), (3, 2), (4, 1), (5, 1)]);
        }
        ...
        mod list_exhaustion {
            ...
            fn test_with_list_exhaustion_during_full_seats_assignment() {
                ...
                let total_seats = get_total_seats_per_converted_list_number_from_result(&result);
                assert_eq!(total_seats, vec![(1, 4), (2, 4), (4, 3), (5, 2), (7, 2)]);
            }
            ...
            fn test_with_list_exhaustion_triggering_2nd_round_highest_average_assignment_with_same_averages()
             {
                ...
                let total_seats = get_total_seats_per_converted_list_number_from_result(&result);
                assert_eq!(total_seats, [(1, 2), (2, 2), (3, 2)]);
            }
            ...
            fn test_with_absolute_majority_of_votes_but_not_seats_and_list_exhaustion() {
                ...
                let total_seats = get_total_seats_per_converted_list_number_from_result(&result);
                assert_eq!(total_seats, vec![(1, 7), (2, 3), (3, 2), (4, 2), (5, 1)]);
            }
            ...
            fn test_with_absolute_majority_of_votes_but_not_seats_and_list_exhaustion_triggering_unique_highest_averages_assignment()
             {
                ...
                let total_seats = get_total_seats_per_converted_list_number_from_result(&result);
                assert_eq!(total_seats, [(1, 4), (2, 3), (3, 1)]);
            }
            ...
            fn test_with_absolute_majority_of_votes_but_not_seats_and_list_exhaustion_triggering_multiple_unique_highest_averages_assignment()
             {
                ...
                let total_seats = get_total_seats_per_converted_list_number_from_result(&result);
                assert_eq!(total_seats, [(1, 2), (2, 1), (3, 5)]);
            }
    ...
    mod gte_19_seats {
        ...
        fn test_with_remainder_seats() {
            ...
            let total_seats = get_total_seats_per_converted_list_number_from_result(&result);
            assert_eq!(total_seats, vec![(1, 12), (2, 6), (3, 1), (4, 2), (5, 2)]);
        }
        ...
        mod list_exhaustion {
            ...
            fn test_with_list_exhaustion_during_full_seats_assignment() {
                ...
                let total_seats = get_total_seats_per_converted_list_number_from_result(&result);
                assert_eq!(total_seats, vec![(1, 4), (2, 5), (3, 4), (4, 4), (5, 3)]);
            }
            ...
            fn test_with_list_exhaustion_during_residual_seats_assignment() {
                ...
                let total_seats = get_total_seats_per_converted_list_number_from_result(&result);
                assert_eq!(total_seats, vec![(1, 5), (2, 4), (3, 4), (4, 4), (5, 2)]);
            }
