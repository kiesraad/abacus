...
static VARIANTS: &[ModelVariant] = &[
    ...
    ModelVariant {
        ...
        model: "model-n-10-1",
        input: "model-n-10-1-variations/model-n-10-1-WS.json",
    },
    ModelVariant {
        name: "model-n-10-1-inlegvel",
        model: "model-n-10-1-inlegvel",
        input: "model-n-10-1-inlegvel.json",
    },
    ModelVariant {
    ...
    ModelVariant {
        name: "model-na-14-1-versie-1-GR",
    ...
    ModelVariant {
        ...
        model: "model-na-31-1",
        input: "model-na-31-1-variations/model-na-31-1-WS.json",
    },
    ModelVariant {
