...
use crate::service::audit_log::ElectionDetails;

crate::domain::identifier::id!(ElectionId);
...
crate::domain::identifier::id!(PGNumber);
...
crate::domain::identifier::id!(CandidateNumber);
