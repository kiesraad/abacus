...
mod tests {
    ...
    use super::*;
    use crate::{
        committee_session::tests::committee_session_fixture, data_entry::PoliticalGroupTotalVotes,
        election::tests::election_fixture, pdf_gen::tests::polling_stations_fixture,
    };
