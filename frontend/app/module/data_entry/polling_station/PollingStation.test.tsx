...
import { overrideOnce, Providers, Router, screen, server, setupTestRouter, waitFor } from "@kiesraad/test";
...
describe("Polling Station data entry integration tests", () => {
  ...
  /*
    ...
    Received:
      NaN
  */
  //   test.only("Progress list shows correct icons", async () => {
  //     const router = renderWithRouter();
  //     await startPollingStationInput(router);
  //     await expectRecountedForm();
  //     await fillRecountedFormNo();
  ...
  //TODO: something is wrong with the routing here
  // Expected: "/elections/1/data-entry"
  // Received: "/elections/1/data-entry/1/1/differences"
