...
describe("UI component: Checkbox", () => {
  test("The checkbox renders with label", () => {
    render(<CheckboxOrRadio id="test-id" type="checkbox" defaultChecked={false} label="Test label" />);
  ...
  test("The checkbox renders with label and description", () => {
    render(
      <CheckboxOrRadio id="test-id" type="checkbox" defaultChecked={false} label="Test label">
        Test description
      </CheckboxOrRadio>,
    );
  ...
  test("The checkbox is checked", () => {
    render(<CheckboxOrRadio id="test-id" type="checkbox" defaultChecked={true} label="Test label" />);
...
describe("UI component: Checkbox Indeterminate", () => {
  test("The checkbox indeterminate renders with label", () => {
    render(<CheckboxOrRadio id="test-id" type="checkbox" defaultChecked={false} label="Test label" indeterminate />);
  ...
  test("The checkbox indeterminate renders with label and description", () => {
    render(
      <CheckboxOrRadio id="test-id" type="checkbox" defaultChecked={false} label="Test label" indeterminate>
        Test description
      </CheckboxOrRadio>,
    );
  ...
  test("The checkbox indeterminate is checked", () => {
    render(<CheckboxOrRadio id="test-id" type="checkbox" defaultChecked={true} label="Test label" indeterminate />);
...
describe("UI component: Radio", () => {
  test("The radio renders with label", () => {
    render(<CheckboxOrRadio id="test-id" type="radio" defaultChecked={false} label="Test label" />);
  ...
  test("The radio renders with label and description", () => {
    render(
      <CheckboxOrRadio id="test-id" type="radio" defaultChecked={false} label="Test label">
        Test description
      </CheckboxOrRadio>,
    );
  ...
  test("The radio is checked", () => {
    render(<CheckboxOrRadio id="test-id" type="radio" defaultChecked={true} label="Test label" />);
