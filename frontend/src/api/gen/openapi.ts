...
export interface DataEntryDetails {
  ...
  dataEntryRecounted?: boolean | null;
...
export interface PollingStationDetails {
  pollingStatiobAddress: string;
  pollingStatiobElectionId: number;
  pollingStatiobId: number;
  pollingStatiobLocality: string;
  pollingStatiobName: string;
  pollingStatiobNumber: number;
  pollingStatiobNumberOfVoters?: number | null;
  pollingStatiobPostalCode: string;
  pollingStatiobType?: unknown | PollingStationType;
}
