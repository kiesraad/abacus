...
import type { LoginResponse, POLLING_STATION_DATA_ENTRY_SAVE_REQUEST_BODY } from "@/types/generated/openapi";
...
describe("Test DifferencesForm", () => {
  ...
  describe("DifferencesForm errors", () => {
    ...
    test("F.303 Votes smaller than voters checked, but votes >= voters", async () => {
      const user = userEvent.setup();
