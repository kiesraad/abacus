...
describe("Test isPollingStationCreateAndUpdateAllowed", () => {
  test.each([
    ...
    { isCoordinator: true, isAdministrator: false, status: "ready", expected: true },
    { isCoordinator: false, isAdministrator: true, status: "ready", expected: true },
    { isCoordinator: false, isAdministrator: false, status: "ready", expected: false },
