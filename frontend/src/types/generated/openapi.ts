...
// /api/elections/{election_id}/download_na_31_2_bijlage_1
export interface ELECTION_DOWNLOAD_NA_31_2_BIJLAGE_1_REQUEST_PARAMS {
  election_id: number;
}
export type ELECTION_DOWNLOAD_NA_31_2_BIJLAGE_1_REQUEST_PATH = `/api/elections/${number}/download_na_31_2_bijlage_1`;
